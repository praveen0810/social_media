      ...
      <div className="container" x-data="{ rightSide: false, leftSide: false }">
            ...
            <div className="timeline">
              <div className="timeline-left">
                ...
                <div className="pages box">
                  ...
                  <div className="user">
                    <img src="https://images.unsplash.com/photo-1549068106-b024baf5062d?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&ixid=eyJhcHBfaWQiOjE3Nzg0f" alt="" className="user-img" />
                    <div className="username">Chandelio</div>
                  </div>
                  <div className="user">
                    <img src="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&s=d5849d81af587a09dbcf3f11f6fa122f" alt="" className="user-img" />
                    <div className="username">Janet Jolie</div>
                  </div>
                  <div className="user">
                    <img src="https://images.unsplash.com/photo-1546539782-6fc531453083?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" alt="" className="user-img" />
        ...
        <div className="right-side" >
          ...
          <div className="account">
            ...
            <span className="account-user">Quan Ha
          ...
          <div className="side-wrapper stories">
            ...
            <div className="user">
              <img src="https://pbs.twimg.com/profile_images/1153966095444992000/1lpIyHaQ.jpg" alt="" className="user-img" />
              <div className="username">Gvozden Boskovsky
                <div className="album-date">29 minutes ago</div>
              </div>
            </div>
            <div className="user">
              <img src="https://images.unsplash.com/photo-1565464027194-7957a2295fb7?ixlib=rb-1.2.1&auto=format&fit=crop&w=3500&q=80" alt="" className="user-img" />
              <div className="username">Hnek Fortuin
                <div className="album-date">3 hours ago</div>
              </div>
            </div>
            <div className="user">
              <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=80" alt="" className="user-img" />
              <div className="username">Lubomir Dvorak
          ...
          <div className="side-wrapper contacts">
            ...
            <div className="user">
              <img src="https://randomuser.me/api/portraits/men/1.jpg" className="user-img" />
              <div className="username">Andrei Mashrin
                <div className="user-status"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&s=046c29138c1335ef8edee7daf521ba50" className="user-img" />
              <div className="username">Aryn Jacobssen
                <div className="user-status offline"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://images.unsplash.com/photo-1575084713138-342cae5f8d00?ixlib=rb-1.2.1&auto=format&fit=crop&w=958&q=80" className="user-img" />
              <div className="username">Carole Landu
                <div className="user-status offline"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://images.pexels.com/photos/598745/pexels-photo-598745.jpeg?h=350&auto=compress&cs=tinysrgb" className="user-img" />
              <div className="username">Chineze Afa
                <div className="user-status"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://pbs.twimg.com/profile_images/2452384114/noplz47r59v1uxvyg8ku.png" className="user-img" />
              <div className="username">Mok Kwang
                <div className="user-status"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://randomuser.me/api/portraits/women/63.jpg" className="user-img" />
              <div className="username">Naomi Yepes
                <div className="user-status"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://images.unsplash.com/photo-1476493279419-b785d41e38d8?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&s=61eaea85f1aa3d065400179c78163f15" className="user-img" />
              <div className="username">Shaamikh Ale
                <div className="user-status"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://m.media-amazon.com/images/M/MV5BMjI4NDcyNjQxNl5BMl5BanBnXkFtZTgwMzI4OTM3NjM@._V1_UY256_CR13,0,172,256_AL_.jpg" className="user-img" />
              <div className="username">Sofia Alcocer
                <div className="user-status idle"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://images.unsplash.com/photo-1509380836717-c4320ccf1a6f?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&s=e01c8c45a063daaf6d6e571a32bd6c90" className="user-img" />
              <div className="username">Wen Yahui
                <div className="user-status"></div>
              </div>
            </div>
            <div className="user">
              <img src="https://pbs.twimg.com/profile_images/737221709267374081/sdwta9Oh.jpg" alt="" className="user-img" />
              <div className="username">Leslee Moss
                <div className="user-status idle"></div>
              </div>
            </div>
          </div>
